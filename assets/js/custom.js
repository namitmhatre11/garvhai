		          		...
		          		$.each( data, function( index, filterValue ) { 
		          			for(var i=0; i<filterValue.length; i++){
		          				...
		          				if(filterValue[i].type == 'image'){
		          					...
		          					modalInnerHtml += '<div class="item" id="modalImg_'+filterValue[i].id+'"><div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="'+filterValue[i].link+'" frameborder="0" allowfullscreen></iframe></div></div>';
		          				}
                 				filterHtml += '</div></div>';
		          			}
		          		}); 
