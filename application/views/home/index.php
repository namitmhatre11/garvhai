                      ...
                      <div class="heros-social-links">
                        <ul class="list-inline">
                          <li class="fb-list">
                           ...
                           <a href="#" class="fb-share-btn social-icon-top" data-username="<?php echo $playerData['name'] ?>" data-playerimage="<?php echo base_url(); ?>uploads/<?php echo $playerData['profile_photo']; ?>"><img src="<?php echo base_url(); ?>assets/img/fb-w.png"></a>
                           <a href="<?php echo base_url(); ?>uploads/<?php echo $playerData['profile_photo']; ?>" data-image="<?php echo base_url(); ?>uploads/<?php echo $playerData['profile_photo']; ?>" data-title="<?php echo $playerData['name']" data-desc="Proud to support <?php echo $playerData['name'] in the Rio Olympics 2016. #GarvHai" class="btnShare"><img src="<?php echo base_url(); ?>assets/img/fb-w.png"></a></li>
