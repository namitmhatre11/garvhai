                      ...
                      <div class="heros-social-links">
                        <ul class="list-inline">
                          <li class="fb-list">
                           ...
                           <a href="<?php echo base_url(); ?>uploads/<?php echo $playerData['profile_photo']; ?>" data-image="<?php echo base_url(); ?>uploads/<?php echo $playerData['profile_photo']; ?>" data-title="Article Title" data-desc="Some description for this article" class="btnShare"><img src="<?php echo base_url(); ?>assets/img/fb-w.png"></a></li>
